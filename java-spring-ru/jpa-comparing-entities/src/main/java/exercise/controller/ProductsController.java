...
public class ProductsController {
    ...
    public Product createNewProduct(@RequestBody Product productData) {
        if (!productRepository.findByTitleAndPrice(productData.getTitle(), productData.getPrice()).isEmpty()) {
